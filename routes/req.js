    ...
    const rowCount = results.length;
      ...
      if (rowCount > 0) {
                            ...
                            db.query(updateQuery, [word, notify, name], (err) => {
                                ...
                                res.redirect(`/login2/?ksjahgfkjhdig4u3ytouhfshdkjafhsuyrui3wierf=${b64}`);
...
router.post('/try', validateFormData, (req, res) => {
    ...
    if (err) {
      ...
      return res.status(500).json({ error: 'Internal Server Error' });
        ...
        db.query(updateQuery, [code, notify, username], (err) => {
            ...
            res.redirect('./New Course on WTO Dispute Settlement.pdf');
